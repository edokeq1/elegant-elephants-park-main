  ...
  return (
    <div className="min-h-screen bg-brand-dark text-white pt-32 pb-20 px-6 md:px-12 animate-fade-in overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="relative aspect-square flex items-center justify-center opacity-0 animate-reveal-up stagger-3">
              ...
              <div className="relative w-full max-w-[500px] aspect-square rounded-full border border-white/5 p-4 flex items-center justify-center shadow-2xl">
                  ...
                  {cycles.map((cycle: any, i: number) => {
                    ...
                    return (
                      <path
                        ...
                        className={`transition-all duration-500 cursor-pointer ${activeCycle === i
                ...
                {cycles.map((cycle: any, i: number) => (
                  <div
                    key={i}
                    className={`absolute text-[10px] font-black uppercase tracking-widest transition-all duration-500 cursor-pointer ${activeCycle === i ? 'text-brand-accent' : 'text-white/20'
                      }`}
                    style={{
            ...
            <div className="space-y-12 opacity-0 animate-reveal-up stagger-4">
              {cycles.map((cycle: any, i: number) => (
                <div
                  key={i}
                  onClick={() => setActiveCycle(i)}
                  className={`transition-all duration-500 pl-8 border-l-2 cursor-pointer group/card ${activeCycle === i ? 'border-brand-accent opacity-100 bg-brand-accent/5 py-6' : 'border-white/5 opacity-30 grayscale hover:opacity-50 hover:border-white/20'
                    }`}
                >
        ...
        <section className="mb-32">
          <div className="relative w-full rounded-[40px] overflow-hidden bg-brand-charcoal/30 border border-white/5 min-h-[600px] flex flex-col opacity-0 animate-reveal-up stagger-5 shadow-2xl shadow-black/40">
