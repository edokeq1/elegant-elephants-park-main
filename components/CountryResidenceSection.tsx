...
export const CountryResidenceSection: React.FC<CountryResidenceSectionProps> = ({ t }) => {
    ...
    return (
        <section ref={sectionRef} className="relative w-full py-24 md:py-32 px-6 md:px-12 bg-brand-dark border-t border-white/5 text-white overflow-hidden z-10">
            ...
            <div className="absolute top-1/2 left-1/2 w-1/2 h-1/2 bg-green-500/5 blur-3xl rounded-full -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
            ...
            <div className="max-w-[1800px] mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
                    ...
                    <div className={`space-y-12 transition-all duration-1000 delay-300 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
                        ...
                        {/* Cadastral Link - Only show if link exists/is provided, otherwise hide or use updated logic */}
                        {t.cadastralLink && (
                            <div className="flex flex-col sm:flex-row gap-4">
                                <a
                                    href="https://kadastrova-karta.com/dilyanka/3222782600:06:003:0106"
                                    target="_blank"
