...
import { MapPin, TrendingUp, Anchor, ExternalLink, School } from 'lucide-react'; // Added School icon for variety if needed, kept generic
import { useScrollAnimation } from '../hooks/useScrollAnimation';
import riverColImage from '../photo/2.jpg';
import { LazyImage } from './LazyImage';

interface RiverColSectionProps {
    t: any;
}

export const RiverColSection: React.FC<RiverColSectionProps> = ({ t }) => {
    ...
    return (
        <section ref={sectionRef} className="relative w-full py-24 md:py-32 px-6 md:px-12 bg-brand-dark border-t border-white/5 text-white overflow-hidden z-10">
            {/* Background Decor - Different position for variety */}
            <div className="absolute bottom-0 left-0 w-1/3 h-full bg-blue-500/5 blur-3xl rounded-full translate-y-1/2 -translate-x-1/2 pointer-events-none" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
                    ...
                    <div className="space-y-12">
                        ...
                        <div className={`flex flex-col sm:flex-row gap-4 transition-all duration-1000 delay-[600ms] transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                            <a
                                href="https://kadastrova-karta.com/dilyanka/3222782600:06:001:0071"
                                target="_blank"
