...
export const CookiePage: React.FC<CookiePageProps> = ({ onBack, t }) => {
  return (
      ...
      <div className="max-w-4xl mx-auto space-y-12 relative z-10">
        ...
        <div className="space-y-8 opacity-0 animate-reveal-up stagger-2">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-4xl md:text-6xl font-light uppercase tracking-tighter leading-none">
                {t.cookies.title} <span className="font-light text-brand-accent-light opacity-50">{t.cookies.subtitle}</span>
              </h1>
          ...
          <div className="prose prose-invert max-w-none space-y-10">
            {t.cookies.sections.map((section: any, index: number) => (
