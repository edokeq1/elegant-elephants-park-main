...
export const TermsPage: React.FC<TermsPageProps> = ({ onBack, t }) => {
  return (
    <div className="min-h-screen bg-brand-dark text-white pt-36 md:pt-32 pb-20 px-6 md:px-12 relative overflow-y-auto animate-fade-in">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-4xl md:text-6xl font-light uppercase tracking-tighter leading-none text-white">
                {t.terms.title} <span className="font-light text-brand-accent-light opacity-50">{t.terms.subtitle}</span>
              </h1>
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-brand-accent/0 rounded-full blur-[120px] -mr-96 -mt-96 opacity-30" />
